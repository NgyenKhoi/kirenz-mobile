...
| 3 | TN-03 | Implement Feature 08 presence/typing/realtime connection interface after Feature 06 | Ready | realtime transport and chat realtime state | Native STOMP/SockJS behavior tested; physical Gateway validation remains explicitly recorded until passed |
...
| 08 | Presence, Typing, Realtime | Not started | WebSocket paths only in config; TN-02 dependency gate has passed | Implement TN-03; physical Android/iOS Gateway transport gate must pass before release |
